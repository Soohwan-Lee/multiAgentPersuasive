  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await fetch('/api/events', {
        ...
        body: JSON.stringify({
          participantId,
          type: 'post_open_survey_2',
          payload: {
            thoughts,
            agentComparison,
            suggestions,
            taskType: 'main2' // Will be updated to specific task type later
          }
        })
      });
      ...
      <Card className="max-w-3xl mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl text-center">
            Post-Session Open-Ended Survey (Session 2)
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-8">
          <div className="text-center mb-6">
            <p className="text-muted-foreground">
              Please share your thoughts and experiences from the second session.
            </p>
          </div>
